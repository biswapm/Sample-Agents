...
using WeatherAgentFramework;
using WeatherAgentFramework.Agent;
...
// In-memory state storage (swap for persistent storage in production)
...
// IChatClient — used by WeatherAgentApp for conversational chat with function invocation
...
{
    app.MapGet("/", () => "WeatherAgentFramework — dotnet + Agent Framework autonomous agent");
